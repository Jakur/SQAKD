...
then
    python3 augment_search.py --gpu_id '0' \
                    ...
                    --batch_size 100 \
                    --seed 20240913 \
                    --teacher_path '/media/justin/SSD Ubuntu Stora/SQAKD_backup_2/results/CIFAR10_VGG8/fp_cutmix/checkpoint/last_checkpoint.pth'
...
then
    python3 augment_search.py --gpu_id '0' \
                    ...
                    --batch_size 100 \
                    --seed 20240913 \
                    --teacher_path '/media/justin/SSD Ubuntu Stora/SQAKD_backup_2/results/CIFAR100_VGG13/fp_cutmix/checkpoint/last_checkpoint.pth'
...
then
    python3 augment_search.py --gpu_id '0' \
                    ...
                    --batch_size 100 \
                    --seed 20240913 \
                    --teacher_path '/media/justin/SSD Ubuntu Stora/SQAKD_backup_2/results/CIFAR10_ResNet20/fp_cutmix/checkpoint/last_checkpoint.pth'
